...
class UserUpdateSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ['id', 'name', 'introduction', 'website_url', 'location', 'twitter', 'profile_image_url', 'update_datetime']

    def update(self, instance, validated_data):
        try:
            instance.name = validated_data.get('name', instance.name)
            instance.introduction = validated_data.get('introduction', instance.introduction)
            instance.website_url = validated_data.get('website', instance.website_url)
            instance.location = validated_data.get('location', instance.location)
            instance.twitter = validated_data.get('twitter', instance.twitter)
            instance.profile_image_url = validated_data.get('images', instance.profile_image_url)
